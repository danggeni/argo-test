package com.argo.test.repository;

import com.argo.test.HelloworldApp;

import com.argo.test.config.Constants;
import com.argo.test.config.audit.AuditEventConverter;
import com.argo.test.domain.PersistentAuditEvent;
...
import static com.argo.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
